                    ...
                    <div className="mt-12 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-8">
                            ...
                            <div className="mx-auto max-w-xs">
                                ...
                                <p className="mt-6 mb-0 leading-normal text-sm text-center">Already have an account? <a href={"/signin"} className="font-bold text-indigo-700 cursor-pointer">Sign in</a></p> 
