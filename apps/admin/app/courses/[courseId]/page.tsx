...
import { courseTitle, coursePrice, isCourseLoading, courseDetails, courseDescription, courseImage } from "@repo/store/src/selectors/course";
    ...
    <Card style={{maxWidth: 600, marginTop: 200, borderRadius: "20px"}} >
        <div style={{padding: 20}}>
            ...
            // bg-gradient-to-tr
                ...
                onClick={async () => {
                    const response = await axios.put(`http://localhost:5000/admin/courses/` + courseDetails?.course?.id, {
                        title: title,
                    ...
                    if (response.data.message == "Course updated"){
                      ...
                      router.push(`/courses/${courseId}/updated`)
                    } else { 
